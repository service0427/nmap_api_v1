...
async def lifespan(app: FastAPI):
    logger.info("Starting up API Server v1.3: Advanced Client & LTE IP tracking active on Port 8011.")
    monitoring_task = None
    yield
    logger.info("Shutting down API Server v1.3: canceling background task.")
    if monitoring_task:
...
app = FastAPI(title="Nmap Production API v1.3 (Advanced Client/IP)", lifespan=lifespan)
